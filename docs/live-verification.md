...
Node must be 20 or newer. The pinned Cursor version for `0.1.0` is `2026.07.20-8cc9c0b`. Authentication status may expose account information; do not paste unredacted output into public logs.
