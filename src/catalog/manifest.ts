...
export const CANONICAL_COMPONENT_DEFS: readonly RawComponentDef[] = [
  ...
  // Agents
  {
    ...
    aliases: ['planner', 'omc_planner', 'omx_planner'],
  ...
  },
  {
    ...
    aliases: ['implementer', 'omc_executor', 'omx_executor', 'executor'],
    pluginManifestEntry: 'agents',
    supportTier: 'native',
  ...
  },
  {
    ...
    aliases: ['explorer', 'omc_explore', 'omx_explore'],
    pluginManifestEntry: 'agents',
    supportTier: 'native',
  ...
  },
  {
    ...
    aliases: ['qa-agent', 'omc_qa_tester', 'omx_qa_tester'],
    pluginManifestEntry: 'agents',
    supportTier: 'native',
  ...
  // Hooks
  {
    ...
    aliases: ['hooks', 'lifecycle-hooks', 'omc_hooks'],
