---
name: omcu-implementer
description: "[omcu:0.3.0] Implement one bounded change with explicit file ownership and targeted tests."
model: inherit
readonly: true
metadata:
  provenance: omcu
  version: 0.3.0
  canonical_id: omcu-agent-implementer
---
