---
name: omcu-reviewer
description: "[omcu:0.3.0] Independently review a scoped diff for introduced correctness, security, and maintainability defects."
model: inherit
readonly: true
metadata:
  provenance: omcu
  version: 0.3.0
  canonical_id: omcu-agent-reviewer
---
